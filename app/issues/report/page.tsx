      ...
      <main className="flex-1 md:ml-0">
        <div className="max-w-2xl mx-auto p-6 md:p-8">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600">Help improve our community by reporting local issues</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-xs text-gray-500 text-center mt-6 leading-relaxed">
              Your issue will be reviewed by city officials. You'll receive updates on its status. Thank you for helping improve our community!
            </p>
          </div>
        </div>
      </main>
