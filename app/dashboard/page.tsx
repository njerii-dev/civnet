    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-start">
            ...
            <div className="flex gap-3">
              <Link
                href="/issues"
                className="px-4 py-2 rounded-lg bg-blue-500 text-white hover:bg-blue-700 transition-colors font-medium"
              >
                View All Issues
              </Link>
              <button
                onClick={handleLogout}
                className="px-4 py-2 rounded-lg bg-white/20 text-white hover:bg-white/30 transition-colors font-medium"
              >
                Logout
              </button>
            </div>
      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-lg shadow p-6 border-l-4 border-l-gray-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg p-6 text-white shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
            <p className="text-3xl mb-3">📊</p>
            <h3 className="text-lg font-bold">View Statistics</h3>
            <p className="text-blue-100 text-sm mt-1">See issue trends and status</p>
          </div>
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg p-6 text-white shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
            <p className="text-3xl mb-3">⭐</p>
            <h3 className="text-lg font-bold">Upvote Issues</h3>
            <p className="text-purple-100 text-sm mt-1">Support important issues</p>
          </div>
        </div>
                  ...
                  <div className="p-6 hover:bg-gray-50 transition-colors cursor-pointer">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="text-right">
                        <div className="inline-block px-4 py-2 bg-blue-50 text-blue-600 rounded-lg font-medium hover:bg-blue-100 transition-colors">
                          View →
                        </div>
                      </div>
                    </div>
